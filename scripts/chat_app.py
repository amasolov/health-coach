...
def _build_system_prompt(user_slug: str, first_name: str) -> str:
    ...
    parts.append(
        ...
        "ifit_workout_id when you know the workout ID — this ensures the "
        "correct workout is used even across conversation boundaries. The "
        "workout ID is available in recommendation results (workout_id field), "
        "search results, and workout detail responses. Do NOT rely solely on "
        "recommendation_index as cached recommendations may be stale.\n"
